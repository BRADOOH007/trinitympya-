...
const TrinityExpressReview = () => {
  ...
  const reviewSchema = {
    ...
    "author": { "@type": "Organization", "name": "Trinity Express Bus Editorial Team" },
    "reviewBody": "Trinity Express Bus offers reliable, comfortable, and affordable bus travel across East Africa. With daily departures, modern buses, and easy online booking, it stands out as a top choice for international bus travel from Nairobi."
  };
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            If you've searched for a bus from Nairobi to Kampala, Kigali, or Juba, you've likely come across <strong>Trinity Express Bus</strong>. In this review, we break down exactly what to expect — from the booking experience to the quality of the buses and the reliability of departures.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Online Booking Experience</h2>
          <p className="text-gray-600 leading-relaxed">
            Trinity Express offers one of the most straightforward online booking systems for East African bus travel. You can book directly on the website in under 3 minutes — select your route, choose your date, pick your seat class, and pay via <strong>M-Pesa or card</strong>. Confirmation is instant.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            Trinity Express operates a modern fleet of air-conditioned coaches. All buses on international routes include:
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            Buses depart daily at <strong>7:00 AM</strong> from the Duruma Road terminal in Nairobi. Trinity Express has a strong track record for on-time departures. Arrival times can vary slightly depending on border crossing wait times, which are outside the company's control.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            Compared to flying, Trinity Express offers exceptional value — especially for routes like Nairobi to Kampala where the bus journey is only 10–12 hours and the price difference is significant.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Routes Covered</h2>
          <p className="text-gray-600 leading-relaxed">
            Trinity Express covers major international routes across East Africa including:
          </p>

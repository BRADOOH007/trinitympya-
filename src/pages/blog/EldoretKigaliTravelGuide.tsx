...
const EldoretKigaliTravelGuide = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        <title>Eldoret to Kigali Bus: Complete 2026 Travel Guide | Trinity Express</title>
        <meta name="description" content="Everything you need to know about the Eldoret to Kigali bus in 2026. Prices from KSh 4,000, schedules, border tips via Kampala, and how to book online." />
        <meta name="keywords" content="Eldoret to Kigali bus, Eldoret Kigali bus ticket, bus from Eldoret to Kigali, Trinity Express Eldoret Kigali, Eldoret Rwanda bus, Eldoret to Kigali 2026" />
        <link rel="canonical" href="https://www.trinityexpressbusonlinebooking.com/blog/eldoret-to-kigali-bus-travel-guide" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Eldoret to Kigali Bus: Complete 2026 Travel Guide" />
        <meta property="og:description" content="Prices, schedules, border tips, and how to book your Eldoret to Kigali bus ticket online in 2026." />
        <meta property="og:url" content="https://www.trinityexpressbusonlinebooking.com/blog/eldoret-to-kigali-bus-travel-guide" />
        <meta property="og:image" content="https://www.trinityexpressbusonlinebooking.com/assets/kampala.jpg" />
        <meta property="article:published_time" content={publishDate} />
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "Article", "headline": "Eldoret to Kigali Bus: Complete 2026 Travel Guide", "datePublished": publishDate, "dateModified": publishDate, "author": { "@type": "Organization", "name": "Trinity Express Bus" }, "publisher": { "@type": "Organization", "name": "Trinity Express Bus", "logo": { "@type": "ImageObject", "url": "https://www.trinityexpressbusonlinebooking.com/assets/logo.jpeg" } }, "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.trinityexpressbusonlinebooking.com/blog/eldoret-to-kigali-bus-travel-guide" } })}</script>
      ...
      <div className="bg-[#1E3A8A] py-16 text-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">Eldoret to Kigali Bus: Complete 2026 Travel Guide</h1>

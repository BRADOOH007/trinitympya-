  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <link rel="canonical" href="https://eattrinityexpress.site/blog/nairobi-to-dar-es-salaam-bus-travel-guide" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Nairobi to Dar es Salaam Bus: Complete 2025 Travel Guide" />
        <meta property="og:url" content="https://eattrinityexpress.site/blog/nairobi-to-dar-es-salaam-bus-travel-guide" />
      ...
      <div className="bg-[#1E3A8A] py-16 text-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">Nairobi to Dar es Salaam Bus: Complete 2025 Travel Guide</h1>

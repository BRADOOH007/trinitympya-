...
const KisumuKampalaTravelGuide = () => {
  ...
  const faqs = [
    ...
    { q: 'Can I book a Kisumu to Kampala bus ticket online?', a: 'Yes. Book your seat on the SimbaCoach website, select your date, choose your seat class, and pay via M-Pesa or card for instant confirmation.' },
  ];

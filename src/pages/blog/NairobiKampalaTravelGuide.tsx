    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 leading-relaxed">
            SimbaCoach buses depart at <strong>7:00 AM daily</strong> from our Duruma Road terminal in Nairobi, typically arriving in Kampala by early evening.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            Booking online with SimbaCoach takes less than 3 minutes:
          </p>
          <ol className="list-decimal pl-6 space-y-2 text-gray-600 mt-4">
            <li>Go to the <Link to="/" className="text-[#1E88E5] hover:underline">SimbaCoach homepage</Link></li>

      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-blue max-w-none text-gray-600">
            ...
            <p>If you have any questions about this privacy policy or our privacy practices, please contact us at: <a href="mailto:info@trinityexpressbusonlinebooking.com" className="text-blue-600 hover:underline">info@trinityexpressbusonlinebooking.com</a></p>
          </div>
        </div>
      </div>
    </div>

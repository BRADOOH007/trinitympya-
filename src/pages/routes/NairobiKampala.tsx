  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.trinityexpressbusonlinebooking.com/routes/nairobi-kampala" />
        ...
        <meta property="og:url" content="https://www.trinityexpressbusonlinebooking.com/routes/nairobi-kampala" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "provider": { "@type": "Organization", "name": "Trinity Express Bus", "url": "https://www.trinityexpressbusonlinebooking.com" },

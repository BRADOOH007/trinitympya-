...
const NairobiJuba = () => {
  ...
  const handleBookNow = () => {
    navigate('/routes', { state: { origin: 'Nairobi', destination: 'Juba' } });
  };
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.trinityexpressbusonlinebooking.com/routes/nairobi-juba" />
        ...
        <meta property="og:url" content="https://www.trinityexpressbusonlinebooking.com/routes/nairobi-juba" />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-4xl font-extrabold text-[#1E3A8A]">USD 45</p>
            <p className="text-orange-600 font-semibold text-sm mt-1">VIP: USD 60</p>
          </div>

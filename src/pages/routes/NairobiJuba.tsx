  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.trinitybusexpress.com/routes/nairobi-juba" />
        ...
        <meta property="og:url" content="https://www.trinitybusexpress.com/routes/nairobi-juba" />

  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Helmet>
        ...
        <link rel="canonical" href="https://eattrinityexpress.site/routes/nairobi-kigali" />
        ...
        <meta property="og:url" content="https://eattrinityexpress.site/routes/nairobi-kigali" />
